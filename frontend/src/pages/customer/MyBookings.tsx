...
export default function MyBookings() {
  ...
  const [cancellingBooking, setCancellingBooking] = useState<NonNullable<typeof data>["bookings"][number] | null>(null)
  ...
  return (
    <>
                ...
                <div className="text-right space-y-2">
                  ...
                  {b.status === "confirmed" && (
                    <button
                      ...
                      className="block text-sm font-heading font-medium text-error hover:underline"
                    >
                      Ajukan Pembatalan
                    </button>
                  )}
      ...
      {cancellingBooking && (
        <CancellationModal booking={cancellingBooking} onClose={() => setCancellingBooking(null)} />
      )}
    </>
  )
}